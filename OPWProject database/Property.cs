...
namespace OPWProject1.Pages.Models
{
    ...
    public class Property
    {
        ...
        public ICollection<Building_Works> Building_Works{ get; set; }

        public Nullable<int> WorkId { get; set; }

        // Constructor
        public Property(int Property_ID, string OPW_Building_code, string Address, string County, Property_Type Type, string Cost_Centre, Property_Team Team)
        {
